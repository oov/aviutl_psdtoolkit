...
func (g *gui) initFont() {
	...
	g.Font.Sans = nk.NkFontAtlasAddFromBytes(atlas, assets.MustAsset("assets/Ohruri-Regular.ttf"), 20, &fc)
	g.Font.Symbol = nk.NkFontAtlasAddFromBytes(atlas, assets.MustAsset("assets/symbols.ttf"), 14, nil)
	nk.NkFontStashEnd()
