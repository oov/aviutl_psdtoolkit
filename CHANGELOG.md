...
- ごちゃまぜドロップスを v0.4.5 に更新
- AudioMixer.auf を v0.3.1 に更新
- かんしくんを v1.6.0beta7 に更新
- 依存ライブラリーの更新

## 0.2.0beta70

- 制御文字 `<ss>` と `<pp>` で意図しない動作をすることがあったのを修正

## 0.2.0beta69

- 特定状況下で `字幕表示（キャッシュ）` が正常に動作しなかったのを修正
- かんしくんを v1.6.0beta5 に更新
